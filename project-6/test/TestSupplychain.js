...
contract('SupplyChain', function (accounts) {
  ...
  it('receiveComponent(): a supplier can receive a component', async () => {
    ...
    assert.equal(resultBuffer[0], upc, 'Error: Invalid item UPC')
    assert.equal(resultBuffer[1], supplierID, 'Error: Missing or Invalid ownerID')
    assert.equal(resultBuffer[2], originManufacturerName, 'Error: Missing or Invalid originManufacturerName')
    assert.equal(resultBuffer[3], originPlant, 'Error: Missing or Invalid originPlant')
    assert.equal(resultBuffer[4], equipmentID, 'Error: Missing or Invalid equipmentID')
    assert.equal(resultBuffer[5], componentNotes, 'Error: Missing or Invalid componentsNotes')
    assert.equal(resultBuffer[6], 6, 'Error: Missing or Invalid componentState')
    assert.equal(resultBuffer[7], supplierID, 'Error: Missing or Invalid supplierID')
    assert.equal(resultBuffer[8], componentState, 'Error: Missing or Invalid componentState')
